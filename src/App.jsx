...
export function StateProvider(props) {//playing, tempo etc...
...
function Transport() {
  ...
  return (
    <div class={styles.transport_bar}>Transport
          ...
          <div class={styles.drum_machine_container}>
            ...
            <div class={styles.sequencer_container}>
              <For each={Array.from({length:6}, (_,i) => i + 1)}>
                {(id) => <Track class={styles.track} id={id} playState={state.playing}/>}
              </For>
